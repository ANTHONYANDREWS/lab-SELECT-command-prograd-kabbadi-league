...
SELECT * 
FROM GAME
WHERE game_date BETWEEN TO_DATE('01-JAN-2020' AND ('31-MAR-2020')
...
FROM event, game
WHERE innings_id = 1 AND game_date = '26-JAN-2020'
